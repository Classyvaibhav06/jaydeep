  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Contrast Film Overlays for text legibility */}
        <div
          style={{
            position: "absolute",
            inset: 0,
            background:
              "linear-gradient(to right, rgba(0,0,0,0.82) 0%, rgba(0,0,0,0.5) 45%, rgba(0,0,0,0.1) 100%)",
            pointerEvents: "none",
          }}
        />
        <div
      ...
      {/* ── TOP HUD ANGLED BORDER LINE (WASP Style) ── */}
      <div
        style={{
          position: "absolute",
          top: 0,
